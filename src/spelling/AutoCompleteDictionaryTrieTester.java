...
public class AutoCompleteDictionaryTrieTester {
	...
	public void testSize()
	{
		...
		assertEquals("Testing isWord on small: hello", true, smallDict.isWord("help"));
		//assertEquals("Testing isWord on small: hello", true, smallDict.isWord("hell"));
		assertEquals("Testing isWord on small: hello", true, smallDict.isWord("hem"));
		assertEquals("Testing isWord on small: hello", true, smallDict.isWord("hot"));
		assertEquals("Testing isWord on small: hello", true, smallDict.isWord("hey"));
		assertEquals("Testing isWord on small: hello", true, smallDict.isWord("a"));
		assertEquals("Testing isWord on small: hello", true, smallDict.isWord("subsequent"));
	...
	public void addWord()
	{
		...
		//assertEquals("Asserting hellow is added in empty dict", true, emptyDict.addWord("hellow"));
		...
		assertEquals("Asserting hellow is in small dict", true, smallDict.isWord("hello"));
	...
	public void testPredictCompletions()
	{
		...
		assertEquals("expected completions size:", 0, completions.size());
