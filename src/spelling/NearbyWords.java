...
public class NearbyWords implements SpellingSuggest {
				...
				for(int index = 0; index < s.length(); index++){
					for(int charCode = (int)'a'; charCode <= (int)'z'; charCode++) {
						...
						if (index==s.length()-1){
							...
							sb2.insert(index+1, (char)charCode);
							if(!currentList.contains(sb2.toString()) && 
									(!wordsOnly||dict.isWord(sb2.toString())) &&
									!s.equals(sb2.toString())) {
   ...
   public static void main(String[] args) {
	   ...
	   String word2 = "tailo";
	   NearbyWords w2 = new NearbyWords(d);
	   List<String> l2 = w2.distanceOne(word2, true);
	   System.out.println("One away word Strings for \""+word2+"\" are:");
	   ...
	   String word3="time";
	   String word4="theme";
	    WPTree tr=new WPTree(w);
	   List<String> lis=tr.findPath(word3, word4) ;
	   for (String s:lis){
